...
(function () {
  ...
  // atual, e garante que o accordion daquele módulo esteja aberto.
  function highlightActiveSidebarLink() {
    ...
    if (collapseEl && !collapseEl.classList.contains('show')) {
      // Fecha os outros módulos e abre o que contém a página atual
      sidebar.querySelectorAll('.accordion-collapse.show').forEach((el) => el.classList.remove('show'));
